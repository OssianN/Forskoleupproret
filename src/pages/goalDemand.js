    ...
    <Layout>
      <div className='goal-demand__container'>
          <section className='main-header section1'>
            ...
            <img className='main-header__hero-img' src={goalImage} alt='demand'></img>
          ...
          <h4 className='goal-demand__link'>Hitta vårt måldokument <a style={{color: '#ff9f50'}} href='https://drive.google.com/file/d/1ao46aacCtTx2C2NfqoV9eoNas2fOYb1e/view?usp=drivesdk'>här</a></h4>
          <h3 className='goal-demand__black-banner'>Framtiden börjar i förskolan!</h3>
          <section className='main-header section2'>
            <h1 className='main-header__h1'>
              Förskoleupprorets krav
            </h1>
            <img className='main-header__hero-img goal-demand__img' src={demandImage} alt='demand'></img>
            ...
            <h4 className='goal-demand__link'>Hitta vårt kravdokument <a style={{color: '#ff9f50'}} href='https://drive.google.com/file/d/15hH8CIBp8xywhOIQXxw8oc4GBeFtKNUP/view?usp=drivesdk'>här</a></h4>
          </section>
      </div>
    </Layout>
  )

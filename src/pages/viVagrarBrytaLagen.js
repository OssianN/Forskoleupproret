    ...
    <Layout>
      <div className='viVagrarBrytaLagen'>
        ...
        <div className='gridView'>
          ...
          <h2 className='main-h2 laws__h2'>Besök vårt dokument</h2>
          <p className='main-p'>
            ...
            <a className='laws__link' href='https://drive.google.com/file/d/1ML2yMr_fDGloLYkRdr9IV8GHtJKSUpNV/view?usp=drivesdk'>Se dokumentet &#x203A;</a>
          </p>
        </div>
        <div className='vittnesmal__container'>
          <img src={img.thousand} alt='1000' className='vittnesmal__img'></img>
          <div className='vittnesmal__textbox'>
            <h2 className='main-h2 vittnesmal__h2'>Vittnesmål</h2>
            <p className=' vittnesmal__p main-p'>
            ...
            <a className='laws__link vittnesmal__link' href='https://drive.google.com/file/d/1ueOYTIpeA1dU3s8e7GXlmzQfh5pFlL6B/view?usp=drivesdk'>
              Gå till berättelserna &#x203A;
            </a>
          </div>
        </div>
        <div className='gridView toTheLeft'>
          <header className='laws__grid-header'>
            <h1 className='main-h1 laws__h1'>ATL</h1>
            <p>Arbetstidslagen</p>
            <span className='laws__section-span'></span>
          </header>
          <p className='main-p'>
            ...
            <br/>
            <br/>
            <a className='laws__link' href='https://www.av.se/arbetsmiljoarbete-och-inspektioner/lagar-och-regler-om-arbetsmiljo/arbetstidslagen/'>ATL i sin helhet &#x203A;</a>
          </p>
        </div>
        <div className='gridView toTheRight'>
          <header className='laws__grid-header'>
            <h1 className='main-h1 laws__h1'>Skollagen</h1>
            <p>(2010:800)</p>
            <span className='laws__section-span'></span>
          </header>
          <p className='main-p'>
            ...
            <br/>
            <br/>
            <a className='laws__link' href='https://www.riksdagen.se/sv/dokument-lagar/dokument/svensk-forfattningssamling/skollag-2010800_sfs-2010-800'>Skollagen i sin helhet &#x203A;</a>
          </p>
        </div>
        <div className='gridView toTheLeft'>
          <header className='laws__grid-header'>
            <h1 className='main-h1 laws__h1'>AML</h1>
          ...
          <p className='main-p'>
            ...
            <br/>
            <br/>
            <a className='laws__link' href='https://www.av.se/arbetsmiljoarbete-och-inspektioner/lagar-och-regler-om-arbetsmiljo/arbetsmiljolagen/'>Arbetsmiljölagen i sin helhet &#x203A;</a>
          </p>
        </div>
        <div className='gridView toTheRight'>
          <header className='laws__grid-header'>
            <h1 className='main-h1'>Offentlighets- och sekretesslagen</h1>
            <span className='laws__section-span'></span>
          </header>
          <p className='main-p'>
            ...
            <br/>
            <br/>
            <a className='laws__link' href='https://www.riksdagen.se/sv/dokument-lagar/dokument/svensk-forfattningssamling/offentlighets--och-sekretesslag-2009400_sfs-2009-400'>Offentlighets- och sekretesslagen i sin helhet &#x203A;</a>
          </p>
        </div>
        <div className='gridView toTheLeft'>
          <header className='laws__grid-header'>
            <h1 className='main-h1 laws__h1'>AVTAL</h1>
            <p>Hök18-ALMEGA-KFO</p>
            <span className='laws__section-span'></span>
          </header>
          <p className='main-p'>
            ...
            <br/>
            <a className='laws__link' href='https://www.lararforbundet.se/artikelsidor/allt-om-skolavtalet-hok-18'>Länk till Hök18 &#x203A;</a>
            <br/>
            <br/>
            <a className='laws__link' href='https://www.lararforbundet.se/artiklar/almega-tjansteforetagen-friskoleavtalet-kollektivavtal-for-anstallda-inom-almega-tjansteforetagen'>Länk till Amega &#x203A;</a>
            <br/>
            <br/>
            <a className='laws__link' href='https://www.lararforbundet.se/artiklar/arbetsgivarforeningen-kfo-sammanfattning-av-kollektivavtalet'>Länk till Kfo &#x203A;</a>
            <br/>
            <br/>
            <a className='laws__link' href='https://skr.se/download/18.485e5900175b8e9831716a4f/1605166705948/HOK-20-Kommunal.pdf'>Länk till HÖK Kommunal &#x203A;</a>
            <br/>
            <br/>
            <a className='laws__link' href='https://skr.se/arbetsgivarekollektivavtal/kollektivavtal/allmannabestammelserab.145.html'>Länk till Allmänna bestämmelser &#x203A;</a>
            <br/>
          </p>
        </div>
      </div>
